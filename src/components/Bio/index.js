function Bio() {
    return (
      <div>
        <h2 id="Bio" className="d-f fxd-r jc-c p-1em">
          Bio
        </h2>
        <p className="ta-c">
          I am a Web Developer with a background in inside sales and have years
          of experience streamlining/optimizing supply chains, finding solutions
          to complex problems, all while providing excellent customer service.
